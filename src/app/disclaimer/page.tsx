  ...
  return (
    <main className="max-w-3xl mx-auto p-4 space-y-6">
      ...
      <section className="space-y-2">
        ...
        <p>为实现请愿书签名管理、支持统计与真实性校验之必要目的，系统将收集并处理您在签名支持时主动提交的姓名、手机号码、手写签名图片等信息，并可能记录必要的技术信息（如时间戳、设备信息与网络标识）。前述信息仅在实现前述目的所必需的范围内使用，不会超出该等范围进行处理。</p>
      </section>

      <section className="space-y-2">
        <h2 className="text-lg font-medium">二、签名统计与系统限制</h2>
        <p>系统采用"同一手机号码仅可签名一次"等合理措施进行重复控制；但鉴于电子系统及网络环境的复杂性，仍可能因不可抗力、第三方攻击、设备异常或其他非可控因素导致统计偏差、延迟或中断。您理解并同意该等客观限制，并认可统计结果可能存在合理误差。</p>
      </section>

      <section className="space-y-2">
        <h2 className="text-lg font-medium">三、合法合规与用途限定</h2>
        <p>本系统仅可用于合法、正当、合规之目的，不得用于违法违规、侵犯他人合法权益或违反公序良俗的活动。您承诺：请愿书主题与内容来源合法，目的正当，且已依法获得必要授权（如适用）。</p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>在实现签名统计及依法留存之必要期间内，系统将以合理方式存储相关数据；保存期限届满或保存目的已达成时，将依法删除或进行去标识化处理，法律法规另有规定或监管要求的除外。</p>
      </section>
